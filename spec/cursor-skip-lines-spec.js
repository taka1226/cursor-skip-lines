...
import CursorSkipLines from '../lib/cursor-skip-lines';
...
describe('CursorSkipLines', () => {
  ...
  describe('when the cursor-skip-lines:move event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      // has been created
      expect(workspaceElement.querySelector('.cursor-skip-lines')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.cursor-skip-lines')).toExist();

        let cursorSkipLinesElement = workspaceElement.querySelector('.cursor-skip-lines');
        expect(cursorSkipLinesElement).toExist();
